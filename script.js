...
if ('SpeechRecognition' in window) {
     ...
     * @returns {string} - Response to be spoken/displayed
     */
    function generateResponse(input) {
        // Expanded library of responses
        const responses = {
            "hello": "Hi there! How can I assist you today?",
            "how are you": "I'm just a program, but I'm here to help!",
            "what is your name": "I'm Lexi, your voice assistant.",
        ...
        // Special handling for "open [website]" commands
        if (input.startsWith("open ")) {
            return "Opening the website you requested.";
        }

        // Match known responses or provide fallback
    ...
    function respond(message, transcript) {
        ...
        if (transcript.startsWith("open ")) {
            // Extract the website name from the transcript
            const website = transcript.replace("open ", "").trim();

            // Define known websites
            const websiteMap = {
            ...
            if (websiteMap[website]) {
                ...
                // Attempt to open the website directly
